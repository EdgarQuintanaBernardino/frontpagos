                            ...
                            <b-row>
                                ...
                                <b-col cols="6">
                                    <b-overlay :show="upload" rounded="sm">
                                        ...
                                        <vue2Dropzone disabled="true" ref="dzcotizacion" id="dcotizacion"
                                            :options="dropzoneOptionscotizacion"
                                            style="border:dashed #20948B 2px;color:black"
                                            @vdropzone-success="vsuccesscotizacion" @vdropzone-complete="afterupload"
                                    ...
                                    <b-container fluid class="">
                                        <b-row style="">
                                            <b-col cols="12" md="6" v-for="item in cotizaciones"
                                                :key="'cotizaciones'+item.id" class="mb-2">
                                                ...
                                                <b-overlay :show="item.reloj" rounded="sm" :id="item.id+'relojc'">
                                                    ...
                                                    <br>
                                                    <b-button class="btn btn-danger ml-2" d-block sytle="display:block"
                                                        :id="item.id+'btnc'" @click="deletefilec(item)">
                                                        <b-icon icon="trash-fill" scale="1" style="color:white;">
                                                        </b-icon>
                                                    </b-button>
                                                </b-overlay>
                            ...
                            <b-row>
                                ...
                                <b-col cols="6">
                                    <b-overlay :show="upload" rounded="sm">
                                        ...
                                        <vue2Dropzone disabled="true" ref="dzorden" id="dorden"
                                            :options="dropzoneOptionscotizacion"
                                            style="border:dashed #20948B 2px;color:black"
                                            @vdropzone-success="vsuccessorden" @vdropzone-complete="afterupload"
                                            @vdropzone-queue-complete="vqueueComplete" @vdropzone-processing="cargando"
                            ...
                            <b-row>
                                ...
                                <b-col cols="6">
                                    <b-overlay :show="upload" rounded="sm">
                                        ...
                                        <vue2Dropzone disabled="true" ref="dzcomprobante" id="dcomprobante"
                                            :options="dropzoneOptionscotizacion"
                                            style="border:dashed #20948B 2px;color:black"
                                            @vdropzone-success="vsuccesscomprobante" @vdropzone-complete="afterupload"
                                            @vdropzone-queue-complete="vqueueComplete" @vdropzone-processing="cargando"
...
export default {
  ...
  methods: {
    ...
    sendingEvent(file, xhr, formData) {
      ...
      console.log(
        "duda: " + this.$parent.$parent.$parent.$parent.$parent.$parent.$parent
      );
