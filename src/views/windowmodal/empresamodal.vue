            ...
            <CCard>
              ...
              <CCardBody>
                ...
                <b-row>
                  <b-col cols="12" md="6" >
                    <label>
                      <span>{{this.form.regimen!=='Cuenta Personal' ? 'Nombre Comercial' : 'Alias'}}</span>
                    </label>
                    <b-input-group size="md">
                      ...
                      <b-form-input
                        ...
                        :placeholder="this.form.regimen!=='Cuenta Personal' ? 'Nombre comercial' : 'Alias'"
                  ...
                  <b-col cols="12" md="6" >
                    <label>
                      <span>{{validarfc ? 'Razón social' : 'Nombre completo'}}</span>
                    </label>
                    <b-input-group size="md">
                      <b-input-group-prepend is-text>
                      ...
                      <b-form-input
                        ...
                        :placeholder="validarfc ? 'Razón social' : 'Nombre completo'"
                        :disabled="this.$store.state.flagempresa == 2"
                      ></b-form-input>
                      <b-tooltip target="razon"
                  ...
                  <b-col cols="12" md="6" class="mt-3" v-if="validarfc">
                    <label>
                      <span>RFC <b-badge>Se utilizará para la facturación</b-badge></span>
                    </label>
                    <b-input-group size="md">
                      <b-input-group-prepend is-text>
                ...
                <br />
                <CCardHeader>
                  <h5>Datos de facturación <b-badge>Se utilizará para la facturación</b-badge></h5>
                </CCardHeader>
                <b-overlay :show="showanimation" rounded="sm">
                  ...
                  <b-row>
                    ...
                    <b-col cols="12" md="6" class="mt-3" >
                    <label>
                      <span>Email <b-badge>Agregar desde datos de contacto como Facturación</b-badge></span>
                    </label>
                    <b-input-group size="md">
                      <b-input-group-prepend is-text>
                  ...
                  <b-col cols="12" lg="6" class="mt-3">
                    <label>
                      <span>Número Telefónico <b-badge>Agregar desde datos de contacto como Facturación</b-badge></span>
                    </label>
                    <b-input-group size="md">
                      <b-input-group-prepend is-text>
